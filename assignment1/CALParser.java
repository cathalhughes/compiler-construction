...
//THE GRAMMAR
  ...
  static final public void paramerter_list() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ID:
      nemp_parameter_list();
      break;
  ...
  static final public void boolean_condition() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case OR:
    case AND:
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0xc00,0xc00,0xe000,0x40180000,0xe000,0x0,0x4000000,0x2a20000,0x2a20000,0x60000000,0x40180000,0x0,0x40180000,0x0,0x0,0x0,0x0,0x40000000,0x180000,0x0,0x0,0x4000000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x2802,0x0,0x2000,0x0,0x2000,0x2000,0x0,0x2802,0x3,0x2806,0x18,0x18,0x3,0x2,0x0,0x2802,0x7e0,0x2000,0x0,};
   }
